...
# Create and fix ownership for ALL required directories
...
# Launch DBus as 'steam' to ensure correct ownership of the bus socket
...
# We explicitly set HOME to ensure config files are found in the right place
...
su - steam -c "export HOME=/home/steam && export XDG_RUNTIME_DIR=$XDG_RUNTIME_DIR && export DBUS_SESSION_BUS_ADDRESS='$DBUS_SESSION_BUS_ADDRESS' && sunshine" &

echo "Starting Gamescope..."
# FIX: Explicitly set HOME=/home/steam so Gamescope doesn't look in /root
exec sudo -E -u steam HOME=/home/steam gamescope \
    -W 2560 -H 1440 \
    -w 2560 -h 1440 \
    -r 60 \
    -F fsr \
