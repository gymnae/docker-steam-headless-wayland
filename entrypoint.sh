...
# This string targets GUID 050000004c05... which is exclusively the PS5 controller on Linux.
# It will NOT affect Xbox controllers (which start with 030000005e04...).
